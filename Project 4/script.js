...
function calculateFD(){
    ...
    document.getElementById("invested-amount").innerText =  `â‚¹${principal.toLocaleString('en-IN')}`;

    document.getElementById("estimated-returns").innerText = ` â‚¹${Math.round(interestEarned).toLocaleString('en-IN')}`;

    document.getElementById("total-value").innerText = ` â‚¹${Math.round(totalAmount).toLocaleString('en-IN')}`;
